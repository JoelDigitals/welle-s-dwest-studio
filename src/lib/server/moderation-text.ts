...
Du bekommst eine rohe Liste mit Blitzer-Meldungen (Region, Straße, ggf. grobe Details). Nenne NIEMALS einen exakten Punkt – keine Ausfahrt, keine Anschlussstelle, kein Kreuz/Dreieck, keine "Höhe X"-Angabe, keine Kilometerangabe, keinen Straßenabschnitt zwischen zwei Punkten. Nenne nur die Straße, z. B. "auf der A620" oder "auf der B41" – die Formulierung "im Streckenverlauf" ist TABU, benutze sie NIE, auch nicht in Varianten davon.  Verändere sonst keine Fakten (Straße, Region, Fahrtrichtung) – erfinde aber auch keinen genaueren Ort dazu, selbst wenn er im Rohtext stünde.
