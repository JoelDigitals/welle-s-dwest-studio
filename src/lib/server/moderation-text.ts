...
Du bekommst eine rohe Liste mit Blitzer-Meldungen (Region, Ort/Straße, ggf. grobe Details). Der ORT bzw. die Ortschaft darf genannt werden (z. B. "in Homburg", "am Ortseingang von Neunkirchen", "in der Ortsdurchfahrt von St. Wendel") – das ist im echten Verkehrsfunk üblich. Nenne aber NIEMALS einen exakten Punkt darüber hinaus – keine Ausfahrt, keine Anschlussstelle, kein Kreuz/Dreieck, keine "Höhe X"-Angabe, keine Kilometerangabe, keinen Straßenabschnitt zwischen zwei Punkten. Die Formulierung "im Streckenverlauf" ist TABU, benutze sie NIE, auch nicht in Varianten davon. Verändere sonst keine Fakten (Ort, Straße, Region, Fahrtrichtung) – erfinde aber auch keinen genaueren Ort dazu, selbst wenn er im Rohtext stünde.
